...
(function()
{
   ...
   $(".container.mypic").attr("src", mypic);
    ...
    We all try to be professional and know our services and products better than anyone\.
    You need a tool to present your Business to the rest of the world\.
    Your website is more than just a formality. It is an extension of your business, and often the first, and possibly only the one way that customer interacts with your business. ";
